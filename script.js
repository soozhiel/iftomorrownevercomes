const SITE_URL = 'https://iftomorrownevercomes.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'If Tomorrow Never Comes — Sonic Remedy | Soozhee', text: 'If Tomorrow Never Comes by Soozhee. Sonic Remedy : Audiosensory Resonance | No Regret.', url: SITE_URL }); return; } catch (e) {} }
